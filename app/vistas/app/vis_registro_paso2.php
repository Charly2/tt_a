...
<!--
<pre>
    <?/* print_r($alumnno['estudiante']['idestudiante']);  */?>
</pre>-->
<div id="form">
                ...
                <div class="my-3">
                    ...
                    <div class="row rowjc">
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                ...
                                <input type="text" name="" class="form-control autoupdate req_this" <?=autoUpdate("conyuge","ocupacion",encryptIt($data['conyuge']['idPadre']),'app/alumno/update',$data['conyuge']['ocupacion'],1,25)?> placeholder="Escribe aquí tu Ocupación" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group ">
                    ...
                    <div class="row rowjc">
                        <div class="col-md-4">
                            <div class="tile">
                                <p class="mb-0">
                                   <?=$dir_top['calle']." ".$dir_top['num_exterior']." ".$dir_top['num_interior']?> <br>
                                    <?=$dir_top['colonia']?><br>
                                    <?="CP: ".$dir_top['cp']." ".$dir_top['municipio']?> <br>
                                    <?=$dir_top['estado']." México"?>
                                </p>
                                <button role="button" id="setDirDer" class="btn btn-primary btn-large btn-block" href="#" >Utilizar dirección</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row rowjc">
                        <div class="col-md-4">
                            <div class="form-group ">
                                ...
                                <input type="text" name="" class="form-control autoupdate req_this dir_pre" data-pre="<?=$dir_top['calle']?>" <?=autoUpdate("direccion","calle ",encryptIt($data['direccion']['idDireccion']),'pre_registro/update',$data['direccion']['calle'],4,25)?> placeholder="Escribe aquí tu domicilio" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group ">
                                <label>Número exterior*:</label>
                                <input type="text" name="" class="form-control autoupdate req_this dir_pre" data-pre="<?=$dir_top['num_exterior']?>" <?=autoUpdate("direccion","num_exterior ",encryptIt($data['direccion']['idDireccion']),'app/alumno/update',$data['direccion']['num_exterior'],1,4)?>  placeholder="Escribe aquí tu número exterior" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group ">
                                <label>Número interior*:</label>
                                <input type="text" name="" class="form-control autoupdate req_this dir_pre" data-pre="<?=$dir_top['num_interior']?>" <?=autoUpdate("direccion","num_interior ",encryptIt($data['direccion']['idDireccion']),'app/alumno/update',$data['direccion']['num_interior'],1,4)?>  placeholder="Escribe aquí tu número interior"/>
                            </div>
                        </div>
                    </div>
                    <div class="row rowjc">
                        <div class="col-md-4">
                            <div class="form-group ">
                                ...
                                <input type="text" name="" class="form-control autoupdate req_this dir_pre" data-pre="<?=$dir_top['cp']?>" data-valido="numeric" <?=autoUpdate("direccion","cp",encryptIt($data['direccion']['idDireccion']),'app/alumno/update',$data['direccion']['cp'],4,5)?>  id="CP" data-activo="sipuede" placeholder="Escribe aquí tu CP"/>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group ">
                                <label>Alcaldía / Municipio*:</label>
                                <input type="text" name="" class="form-control autoupdate req_this dir_pre" data-pre="<?=$dir_top['municipio']?>" id="MU" placeholder="" <?=autoUpdate("direccion","municipio ",encryptIt($data['direccion']['idDireccion']),'app/alumno/update',$data['direccion']['municipio'],4,25)?>  value="Gustavo A. Madero" disabled="disabled"/>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group ">
                                <label>Entidad Federativa*:</label>
                                <input type="text" name="" class="form-control autoupdate req_this dir_pre" data-pre="<?=$dir_top['estado']?>" id="EN" placeholder="" <?=autoUpdate("direccion","estado",encryptIt($data['direccion']['idDireccion']),'app/alumno/update',$data['direccion']['estado'],4,25)?> value="México" disabled="disabled"/>
                            </div>
                        </div>
                    </div>
                    <div class="row rowjc">
                        <div class="col-md-4">
                            <div class="form-group ">
                                <label>Colonia*:</label>
                                <select type="text"  class="form-control autoupdate req_this dir_pre_selc" id="colonias" data-pre="<?=$dir_top['colonia']?>"  <?=autoUpdate("direccion","colonia",encryptIt($data['direccion']['idDireccion']),'app/alumno/update',$data['direccion']['colonia'],4,null)?> >
                    ...
                    <div class="row rowjc">
                        ...
                        <div class="col-md-4">
                            <div class="form-group ">
                                ...
                                <input type="text" name="" class="form-control hora autoupdate req_this" <?=autoUpdate("conyuge","entrada ",encryptIt($data['conyuge']['idPadre']),'app/alumno/update',$data['conyuge']['entrada'],1,15)?>  placeholder="Escribe aquí tu Horario de entrada"/>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group ">
                                <label>Horario de salida de trabajo*:</label>
                                <input type="text" name="" class="form-control hora autoupdate req_this" <?=autoUpdate("conyuge","salida ",encryptIt($data['conyuge']['idPadre']),'app/alumno/update',$data['conyuge']['salida'],1,15)?>  placeholder="Escribe aquí tu Horario de salida"/>
                            </div>
                        </div>
                    </div>
                    <div class="row rowjc">
    ...
    $( function() {
        ...
        $('#finalizar').click(function (e) {
            ...
            if ($_Err > 0){
                ...
                window.location.href = "<?=URL_BASE?>app/alumno/reg_persona_autorizada/<?=$alumnno['estudiante']['idestudiante']?>"
        ...
        $('#CP').change(function (e) {
            console.log(this.dataset.activo)
            if (ACTIVOCP) {
        ...
        $('#setDirDer').click(function (e) {
            this.innerHTML = "Dirección seleccionada"
            ACTIVOCP = false;

            $('.dir_pre').each(function (e,t) {
                this.value = this.dataset.pre;

                $(this).trigger('change');
            });
            ACTIVOCP = true;
            $valor = $('.dir_pre_selc').data('pre');
            $('.dir_pre_selc').html('<option value="'+$valor+'">'+$valor+'</option>').trigger('change');
